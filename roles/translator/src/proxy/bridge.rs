...
impl Bridge {
    ...
    fn handle_downstream_share_submission(self_: Arc<Mutex<Self>>, tx_status: Sender<Status>) {
    ...
    /// connection will close.
    fn handle_new_extended_mining_job(self_: Arc<Mutex<Self>>, tx_status: Sender<Status>) {
